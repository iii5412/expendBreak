...
import { ShieldCheck, Zap, UserCheck, Sparkles, Calendar } from 'lucide-react';
...
export const Navbar: React.FC<NavbarProps> = ({ userProfile, nextPaydayText, onOpenSettings }) => {
  return (
