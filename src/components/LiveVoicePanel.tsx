    ...
    return {
      ...
      session: {
        ...
        instructions: [
          ...
          '지출 초안은 payment_method를 반드시 채우고, 사용자가 카드나 계좌 이름을 말하면 card_name 또는 account_name에 위 별칭을 정확히 넣는다.',
          '카드 할부를 말하면 installment_months에 총 할부 개월, installment_current_round에 이번 달 회차를 넣는다. 회차를 말하지 않으면 1이다.',
          ...
          },
          {
            ...
            parameters: {
              ...
              properties: {
                ...
                installment_months: { type: 'integer', minimum: 1, maximum: 60 },
                installment_current_round: { type: 'integer', minimum: 1, maximum: 60 },
                tags: { type: 'array', items: { type: 'string' }, maxItems: 5 },
                spoken_summary: { type: 'string', description: '사용자가 말한 거래 요청을 보존한 한국어 문장' },
                confidence: { type: 'number', minimum: 0, maximum: 1 },
                reason: { type: 'string' },
              },
              required: ['type', 'amount', 'date', 'merchant', 'category_name', 'payment_method', 'spoken_summary', 'confidence'],
              additionalProperties: false,
            },
          },
        ],
